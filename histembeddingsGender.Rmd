...
head(trait)
```
The job titles were scraped off this site: https://theodora.com/dot_index.html, a 1971 survey on job titles. They were merged with one-word titles from ONET, the modern equivalent: https://www.onetonline.org/find/all. 
...
ts0 <- get_ts("men", "women", "chore", "coha")
...
plot_one_decade(get_decade("men", "women", "chore", "engall", 1980))
